...
const PersonalInformation = () => {
  ...
  // ✅ Helper function: validate and save data
  const handleContinue = () => {
    ...
    // ✅ Save all fields into the shared RegisterContext
    updateUserData({
      firstName: firstName.trim(),
      middleName: middleName.trim(),
      lastName: lastName.trim(),
      birthday: dateOfBirth.toISOString().split("T")[0], // convert Date → yyyy-MM-dd
      password: password,
    });
